...
public class JavaFXPaycheck extends Application {
    ...
    private static Button btnClear;  // object references for the Clear
    private static Button btnExit;   // and Exit Buttons
    ...
    private static void createControls(Pane root) {
        ...
        // Changed it from "Dan's Paycheck Calculator" to "Jenesis' Paycheck Calculator"
        lblTitle = new Label("Jenesis' Paycheck Calculator");
        ...
        btnCompute = new Button("Compute");
            ...
            //creating Clear Button based on the code 
            //for Compute button
            btnClear = new Button("Clear");
            btnClear.setFont(font18);
            btnClear.setLayoutX(160); //changed layout by x4 so buttons are next to each other
            ...
            //creating Exit Button based on the code 
            //for Compute button
            btnExit = new Button("Exit");
            btnExit.setFont(font18);
            btnExit.setLayoutX(300); //changed layout by another x4 so buttons are next to each other
